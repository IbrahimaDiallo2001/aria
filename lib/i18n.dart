...
const Map<String, Map<String, String>> kI18n = {
  ...
  'Choisir un fichier': {'en': 'Choose a file', 'es': 'Elegir un archivo', 'ar': 'اختر ملفاً', 'wo': 'Tànn benn fiise'},
  'ou colle ta sauvegarde :': {'en': 'or paste your backup:', 'es': 'o pega tu copia:', 'ar': 'أو الصق نسختك الاحتياطية:', 'wo': 'walla rendal sa sauvegarde :'},
  'Rappel du journal (soir)': {'en': 'Journal reminder (evening)', 'es': 'Recordatorio del diario (noche)', 'ar': 'تذكير اليوميات (مساءً)', 'wo': 'Fàttali téere bi (ngoon)'},
  "N'oublie pas ton journal du soir ✍️": {'en': "Don't forget your evening journal ✍️", 'es': 'No olvides tu diario nocturno ✍️', 'ar': 'لا تنسَ يومياتك المسائية ✍️', 'wo': 'Bul fàtte sa téere ngoon ✍️'},
  "jour d'écriture": {'en': 'day of writing', 'es': 'día de escritura', 'ar': 'يوم كتابة', 'wo': 'fan bu bind'},
  "jours d'écriture": {'en': 'days of writing', 'es': 'días de escritura', 'ar': 'أيام كتابة', 'wo': 'fan yu bind'},
  'Rechercher…': {'en': 'Search…', 'es': 'Buscar…', 'ar': 'ابحث…', 'wo': 'Seet…'},
  'Aucun résultat': {'en': 'No results', 'es': 'Sin resultados', 'ar': 'لا نتائج', 'wo': 'Dara feeñul'},
